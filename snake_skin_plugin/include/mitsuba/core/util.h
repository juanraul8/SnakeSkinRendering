...
// -----------------------------------------------------------------------
//! @{ \name Thin-film interference
// -----------------------------------------------------------------------

/**
 * \brief Calculates the unpolarized Thin-film transmission coefficient
 ...
 * \param n0
 *      External medium index of refraction
 * \param n1
 *      "Between" medium index of refraction
 * \param n2
 *      Internal medium index of refraction
 * \ingroup libpython
 */
extern MTS_EXPORT_CORE Float ThinFilmTransmission(Float cos0, Float lambda, Float thickness,
                                                        Float n0, Float n1, Float n2);

/**
 * \brief Calculates the unpolarized Thin-film reflection coefficient
 * at a planar interface 
 *
 * The transmitted direction must be provided. There is no logic pertaining to
 * total internal reflection or negative direction cosines.
 ...
 *      Cosine of the incident angle
 * \param lambda
 *      Wavelenght of the incident light (it would be in nanometers and for RGB)
 * \param n0
 *      External medium index of refraction
 * \param n1
 *      "Between" medium index of refraction
 ...
 * \ingroup libpython
 */
extern MTS_EXPORT_CORE Float ThinFilmReflectance(Float cos0, Float lambda, Float thickness,
                                                        Float n0, Float n1, Float n2);
 ...
 * at a planar interface 
 *
 * In comparison to \ref ThinFilmTransmission(), this function internally
 ...
 * \ingroup libpython
 */
extern MTS_EXPORT_CORE Float ThinFilmTransmissionExt(Float cos0, Float &cosThetaT_, Float lambda, Float thickness,
                                                        Float n0, Float n1, Float n2);
 ...
 * at a planar interface 
 * 
 * In comparison to \ref ThinFilmReflectance(), this function internally
 * computes the transmitted direction and returns it using the \c cosThetaT
 * argument. When encountering total internal reflection, it sets
 * <tt>cosThetaT=0</tt> and returns the value 1.
 *
 ...
 * \ingroup libpython
 */
extern MTS_EXPORT_CORE Float ThinFilmReflectanceExt(Float cos0, Float &cosThetaT_, Float lambda, Float thickness,
                                                        Float n0, Float n1, Float n2);
